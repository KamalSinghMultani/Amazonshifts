...
REM v7 adds known-job POSTED/capacity detection over v6's unchanged hold path.
...
:loop
echo [%date% %time%] starting optimized watcher v7 with %CONFIG%
".venv\Scripts\python.exe" watcher_v7.py --config "%CONFIG%"
